...
if __name__ == '__main__':
    Example(detector=PersonDetector(device='CPU',
                                    ...
                                    model='/workspaces/dummy_detecting/assets/person-detection/person-detection-0202-fp32.xml',
                                    weights='/workspaces/dummy_detecting/assets/person-detection/person-detection-0202-fp32.xml',
                                    input_type='float32',
